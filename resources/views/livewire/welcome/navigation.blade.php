<div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
    @auth
        <a data-tip="Dashboard" href="{{ url('/dashboard') }}" class="font-semibold tooltip text-gray-600 hover:text-gray-900 focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500" wire:navigate>
            Dashboard
        </a>
    @else
